...
//Logic for comparing input to quote
userInput.addEventListener("input", () => {
    ...
    quoteChars.forEach((char,index) => {
        ...
        //If user hasn't entered anytthing or backspaced
        ...
        //If user enters wrong character
            ...
            //checks if we already have added a fail class
...
function updateTimer(){
    if(time == 0){
        //End test if the timer reaches 0
        displayResult();
    }else{
